...
const blockData = {
  ...
  colour: "#ab9916",
  tooltip: "Triggered when the mouse gets released",
  helpUrl: "",
};
...
javascript.javascriptGenerator.forBlock["on_mouseup"] = function (
  block,
  generator
) {
...
${variable_spritevar}.on("pointerup", async () => {\n${statements_actions}});
//end-bottom\n`;
  return code;
};
