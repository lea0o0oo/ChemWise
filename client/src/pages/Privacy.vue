<template>
  <div
    class="min-h-[calc(100vh-70px)] w-full prose lg:prose-xl dark:prose-invert p-10"
  >
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Campfire Hub.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Campfire Hub, accessible from
          <a
            href="campfirehub.vercel.app"
            rel="external nofollow noopener"
            target="_blank"
            >campfirehub.vercel.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>Projects images</li>
    </ul>
    <h4>Projects images</h4>
    <p>Project images are uploaded by users, and are used in projects</p>
    <p>
      All the <strong>images</strong> that get uploaded are hosted on
    ...
    <ul>
      <li>
        ...
        <a
          href="https://github.com/campfirehub"
          rel="external nofollow noopener"
          target="_blank"
          >https://github.com/campfirehub</a
        >
      </li>
    </ul>
  </div>
